...
public class DeleteVisitorProductTask extends AsyncTask<String, Void, String>
{
    ...
    public DeleteVisitorProductTask(FetchDataListener listener,SQLiteDatabase database) 
    {
    ...
    protected void onPostExecute(String s) 
    {
        ...
        if(listener != null)
        {
        	listener.onFetchComplete("delete:"+s);
        	return;
        }
    }
